...
public abstract class RedPacketFrame extends JFrame {
    ...
    private static final String DIR = "191124_first-time-use\\pic";
...
//        SystemDemo.out.println("层次面板||" + layeredPane);
        // SystemDemo.out.println(layeredPane);
...
//        SystemDemo.out.println("LOGO初始化...");
...
//        SystemDemo.out.println("输入页面||" + inputPanel);
...
//        SystemDemo.out.println("打开页面||" + openPanel);
    }
...
//        SystemDemo.out.println("展示页面||" + showPanel);
        // ====================================
...
//        SystemDemo.out.println("重新设置:新页面");
    ...
    private void addListener() {
        ...
        input_count.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                // SystemDemo.out.println(e);
//                SystemDemo.out.println("个数:" + input_count.getText());
            }
        });
        input_msg.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                // SystemDemo.out.println(e);
//                SystemDemo.out.println("留言:" + input_msg.getText());
            }
        });
...
//                    SystemDemo.out.println("跳转-->打开新页面");
...
//                SystemDemo.out.println("跳转-->展示页面");

                moneyList = openWay.divide(totalMoney, count);

//                SystemDemo.out.println(moneyList);
                /*
                 * showPanel 添加数据
                 *
                 */
